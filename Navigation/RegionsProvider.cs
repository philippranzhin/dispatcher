            ...
            this.Regions = new Dictionary<string, NavigableRegion>()
                               {
                                   ...
                                   {
                                       RegionNames.EditRegister,
                                       new NavigableRegion(RegionNames.EditRegister, typeof(EditRegister))
                                   },
                                   {
                                       RegionNames.Log,
                                   ...
                                   {
                                       RegionNames.SettingsLog,
                                       new NavigableRegion(RegionNames.SettingsLog, typeof(Log))
                                   },
                                   {
